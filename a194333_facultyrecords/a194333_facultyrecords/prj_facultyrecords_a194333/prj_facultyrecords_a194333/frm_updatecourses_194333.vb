Public Class frm_updatecourses_194333

    Dim current_code As String
    Private Sub frm_updatecourses_194333_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub grd_courses_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles grd_courses.CellClick
    ...
    Private Sub btn_update_Click(sender As Object, e As EventArgs) Handles btn_update.Click
        ...
        run_sql_command("UPDATE TBL_COURSES_A194333 SET FLD_COURSE_NAME='" & txt_name.Text & "', FLD_COURSE_CREDITS=" & txt_credit.Text & ", FLD_MANAGING_DEPT='" & txt_dept.Text & "' WHERE FLD_COURSE_ID='" & current_code & "'")
    ...
    Private Sub btn_delete_Click(sender As Object, e As EventArgs) Handles btn_delete.Click
        ...
        If delete_confirmation = MsgBoxResult.Yes Then
            ...
            run_sql_command("DELETE FROM TBL_COURSES_A194333 WHERE FLD_COURSE_ID='" & current_code & "'")
