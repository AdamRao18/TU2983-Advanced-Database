Module mod_globals_a194333

    Public username As String

    Public myconnection As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB_FACULTYRECORDS_A194333.accdb;Persist Security Info=False;"
